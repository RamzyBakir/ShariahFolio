...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{custom_fig1_full_architecture.png}}
\caption{ShariahFolio system architecture}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{custom_fig2_agent_workflow.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{custom_fig3_lstm_architecture.png}}
\caption{LSTM network architecture for stock return prediction with 30-day input sequences.}
\label{fig:lstm_arch}
\end{figure}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{custom_fig5_data_pipeline.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.4\textwidth]{custom_fig7_shariah_funnel.png}}
\caption{Shariah compliance screening funnel.}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{custom_fig4_optimization_process.png}}
\caption{Portfolio optimization pipeline.}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{custom_fig10_feature_importance.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.48\textwidth]{custom_fig8_performance_comparison.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{custom_fig9_efficient_frontier.png}}
\caption{Efficient frontier of ShariahFolio's optimal portfolio (green star) compared to equal-weight and market index positions.}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{custom_fig6_websocket_flow.png}}
\caption{WebSocket communication sequence diagram.}
\label{fig:websocket}
\end{figure}
